...
module Iu::Ui
  ...
  class Grid < Iu::Widget::Control
    ...
    def insert(widget : Iu::Widget::Widget, next_to : Iu::Widget::Widget, side : Iu::Struct::Side, cell_info : GridCell)
      UI.grid_insert_at(
        to_unsafe,
    ...
    def push(widget : Iu::Widget::Widget, coords : Tuple(Int32, Int32), cell_info : GridCell)
      UI.grid_append(
        to_unsafe,
        ui_control(widget.control.to_unsafe),
        coords[0], coords[1],
