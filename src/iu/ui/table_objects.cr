module Iu::Ui
  class Table < Iu::Widget::Control
    class Value
      @this : UI::TableValue*

      def initialize(color : Iu::Struct::Color)
      ...
      def initialize(image : Iu::Ui::Image)
      ...
      def color : Iu::Struct::Color
        UI.table_value_color(to_unsafe, out r, out g, out b, out a)
        return Iu::Struct::Color.new(r, g, b, a)
      end

      def image : Iu::Ui::Image
        return Iu::Ui::Image.new(UI.table_value_image(to_unsafe))
      end
